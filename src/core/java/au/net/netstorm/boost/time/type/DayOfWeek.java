...
public final class DayOfWeek {
    ...
    private void validate() {
        if (value < Calendar.SUNDAY || value > Calendar.SATURDAY)
            throw new IllegalArgumentException("Invalid day (day=" + value + ").");
    }
    ...
    static void jdkCalendarCheck() {
        ...
        if (Calendar.SUNDAY != 1) throw new IllegalStateException(
                "Expected Calendar.SUNDAY to be 1, instead it was " + Calendar.SUNDAY);
        if (Calendar.MONDAY != 2) throw new IllegalStateException(
                "Expected Calendar.MONDAY to be 2, instead it was " + Calendar.MONDAY);
        if (Calendar.TUESDAY != 3) throw new IllegalStateException(
                "Expected Calendar.TUESDAY to be 3, instead it was " + Calendar.TUESDAY);
        if (Calendar.WEDNESDAY != 4) throw new IllegalStateException(
                "Expected Calendar.WEDNESDAY to be 4, instead it was " + Calendar.WEDNESDAY);
        if (Calendar.THURSDAY != 5) throw new IllegalStateException(
                "Expected Calendar.THURSDAY to be 5, instead it was " + Calendar.THURSDAY);
        if (Calendar.FRIDAY != 6) throw new IllegalStateException(
                "Expected Calendar.FRIDAY to be 6, instead it was " + Calendar.FRIDAY);
