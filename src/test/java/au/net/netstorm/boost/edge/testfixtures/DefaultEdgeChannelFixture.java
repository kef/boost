...
import au.net.netstorm.boost.edge.testdata.AutoEdgeWritableByteChannel;
...
public final class DefaultEdgeChannelFixture implements EdgeChannelFixture {
    ...
    public Class<?>[] srcTypes() {
        return srcTypes;
    }

    public Class<?>[] trgTypes() {
        return trgTypes;
    }
    ...
    public int length() {
        return bufferFixture.length();
    }

    public ByteBuffer buffer() {
        return bufferFixture.buffer();
    }
