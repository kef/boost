...
public class DefaultMethodTestUtil implements FieldTestUtil {
    ...
    public Object getStaticField(Class cls, String fieldName) {
        return getFieldValue(cls, DefaultMethodTestUtil.MARKER_STATIC_FIELD, fieldName);
    }
    ...
    public void setStaticField(Class cls, String fieldName, Object fieldValue) {
        Object ref = DefaultMethodTestUtil.MARKER_STATIC_FIELD;
        setField(cls, ref, fieldName, fieldValue);
    }
