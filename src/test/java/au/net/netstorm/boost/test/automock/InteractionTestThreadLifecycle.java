...
public class InteractionTestThreadLifecycle implements TestThreadLifecycle {
    ...
    public InteractionTestThreadLifecycle(InteractionTestCase testCase, InteractionTestState state) {
