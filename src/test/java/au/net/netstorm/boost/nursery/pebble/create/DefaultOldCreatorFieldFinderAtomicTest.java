...
public final class DefaultOldCreatorFieldFinderAtomicTest extends TestCase {
    private Fred object = new Fred();
    private OldCreatorFieldFinder subject = new DefaultOldCreatorFieldFinder();
    ...
    private Field[] createExpectedCreatorFields() {
        ...
        fields[0] = getField("newTedImpl");
        fields[1] = getField("newDefaultNed");
        return fields;
    }
