...
public final class DefaultAutoEdgeCompoundAtomicTest extends LifecycleTestCase implements HasFixtures, InjectableTest, InjectableSubject, LazyFields {
    ...
    public void setUpFixtures() {
        subject = new DefaultAutoEdge(WritableByteChannel.class, fixture.channel());
        cosubject = new DefaultAutoEdge(ByteBuffer.class, fixture.buffer());
    }
    ...
    public void testInvokeWithEdgedArgument() {
        ...
        expect.oneCall(warperMock, fixture.trg(), "warp", WritableByteChannel.class, fixture.src());
