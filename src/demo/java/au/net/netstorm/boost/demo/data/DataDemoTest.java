...
public final class DataDemoTest extends TestCase {
    ...
    public void testBadAtoms() {
        ...
        checkBad(NoArrayCopyOnCreateIllegalData.class, SINGLE_ARRAY_PROPERTY, "Array was not copied on access.  Arrays must be copied on create and on each access.  Try using arrayRef.clone().");
    }
