...
public final class ComplexCyclicDependenciesDemoTest extends BoooostCase {
    ...
    {
        registry.prototype(Teacher.class, DefaultTeacher.class);
        registry.prototype(Student.class, DefaultStudent.class);
        registry.prototype(Homework.class, DefaultHomework.class);
        registry.prototype(Exam.class, DefaultExam.class);
    }
